...
def generate_launch_description():
    ...
    # ZED camera launch
    camera_one_launch = IncludeLaunchDescription(
    ...
    camera_two_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('zed_wrapper'),
                'launch',
        ...
        launch_arguments = {
            'camera_name': 'zed_two',
            'serial_number': '37817095',
            'camera_model': LaunchConfiguration('zed_camera_model'),
            'publish_tf': LaunchConfiguration('zed_publish_tf'),
            'publish_urdf': LaunchConfiguration('zed_publish_urdf')
        }.items()
    )
    camera_three_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('zed_wrapper'),
                'launch',
        ...
        launch_arguments = {
            'camera_name': 'zed_three',
            'serial_number': '36374190',
            'camera_model': LaunchConfiguration('zed_camera_model'),
            'publish_tf': LaunchConfiguration('zed_publish_tf'),
            'publish_urdf': LaunchConfiguration('zed_publish_urdf')
        }.items()
    )
    camera_four_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('zed_wrapper'),
                'launch',
        ...
        launch_arguments = {
            'camera_name': 'zed_four',
            'serial_number': '36240144',
            'camera_model': LaunchConfiguration('zed_camera_model'),
            'publish_tf': LaunchConfiguration('zed_publish_tf'),
            'publish_urdf': LaunchConfiguration('zed_publish_urdf')
        }.items()
